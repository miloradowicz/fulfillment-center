      ...
      <CardContent className="space-y-6 text-sm leading-relaxed text-muted-foreground">
        ...
        <div>
          ...
          <ul className="list-disc pl-5">
            ...
            <li>Вкладки с товарами, браком, списаниями и историей изменений</li>
          </ul>
        ...
        <div>
          ...
          <p>
            ...
            перемещаются в архив и исключаются из основного списка. Важно отметить, что склад можно архивировать только
            когда в нем нету хранящихся товаров.
          </p>
        </div>
