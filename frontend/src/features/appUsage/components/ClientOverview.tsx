      ...
      <CardContent className="space-y-6 text-sm leading-relaxed text-muted-foreground">
        ...
        <div>
          ...
          <ul className="list-disc pl-5">
            ...
            <li><strong>Адрес</strong> — адрес клиента (необязательное поле)</li>
            <li><strong>Банковские реквизиты</strong> — расчетный счет (необязательное поле)</li>
            <li><strong>ОГРН</strong> — основной государственный регистрационный номер (необязательное поле)</li>
          </ul>
          <p className="mt-2">
        ...
        <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
          ...
          <ul className="list-disc pl-5 text-blue-700 space-y-1">
            <li>Имя клиента должно быть уникальным в системе</li>
            <li>Телефонный номер и email проверяется на корректность формата</li>
            <li>При архивации клиента, все товары, относящиеся к архивируемому клиенту, тоже попадают в архив</li>
