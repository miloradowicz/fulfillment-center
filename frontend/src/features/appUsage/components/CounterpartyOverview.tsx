  ...
  return (
    <Card className="rounded-2xl shadow-md">
      ...
      <CardContent className="space-y-6 text-sm leading-relaxed text-muted-foreground">
        <p>
          <strong>Система управления контрагентами</strong> предоставляет удобный интерфейс для эффективной работы
          с поставщиками, подрядчиками и другими внешними организациями:просматривать, создавать, редактировать
          и архивировать контрагентов.
        </p>
        ...
        <div>
          ...
          <p>
            Чтобы добавить нового контрагента нажмите кнопку <strong>«Добавить контрагента»</strong>.
