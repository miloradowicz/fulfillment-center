    ...
    <Card className="rounded-2xl shadow-md">
      ...
      <CardContent className="space-y-6 text-sm leading-relaxed text-muted-foreground">
        ...
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1 mt-2">
            <li><strong>Клиент</strong> — выбор клиента, для которого осуществляется поставка. Обязательное поле.</li>
            <li><strong>Склад</strong> — склад, на который поступает товар. Обязательное поле.</li>
            <li><strong>Компания-перевозчик</strong> — контрагент, осуществляющий транспортировку груза.</li>
            <li><strong>Адрес доставки</strong> — место, куда была доставлена поставка. Текстовое поле.</li>
            <li><strong>Статус поставки</strong> — текущий статус поставки (например: "в пути", "доставлено",
              "отменено"). Обязательное поле.
            </li>
            <li><strong>Дата прибытия</strong> — фактическая или планируемая дата прибытия поставки.</li>
            ...
            <li><strong>Отправленные товары</strong> — добавление отправленных товаров, включая:
              <ul className="list-disc pl-5">
                <li>Наименование товара</li>
                <li>Количество</li>
                <li>Описание (необязательное)</li>
              </ul>
            </li>
            <li><strong>Полученные товары</strong> — фактически принятые товары. Поля аналогичны «Отправленным товарам».
            </li>
            <li><strong>Дефекты</strong> — товары, которые были получены с дефектами. Можно указать:
              <ul className="list-disc pl-5">
                <li>Товар</li>
                <li>Количество</li>
                <li>Причина (текст)</li>
            ...
            <li><strong>Услуги</strong> — услуги, оказанные при поставке. По умолчанию данные
              подставляются автоматически, но при желании можно их корректировать. <br/>
              Форма включает:
            <ul className="list-disc pl-5">
              <li>Наименование услуга</li>
              <li>Количество</li>
              <li>Цена за единицу</li>
            </ul>
            </li>
            <li><strong>Документы</strong> — прикреплённые файлы (PDF, Word, Excel), не более 10 МБ каждый. Можно
          ...
          <ol className="list-decimal pl-5 space-y-2">
            ...
            <li>
              ...
              <ul className="list-disc pl-5 mt-1">
                ...
                <li>Все полученные товары автоматически сохраняются в системе, в разделе «Склад»</li>
              </ul>
            </li>
            <li>
