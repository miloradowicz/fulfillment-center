    ...
    <Card className="rounded-2xl shadow-md">
      ...
      <CardContent className="space-y-6 text-sm leading-relaxed text-muted-foreground">
        <p>
          ...
          товарными позициями: создавать, просматривать, редактировать и архивировать товары.
        </p>
        ...
        <div>
          ...
          <p>
            ...
            фильтровать список, быстро находить нужный товар и выполнять действия через
        ...
        <div>
          ...
          <p>
            ...
            с полной информацией: название, артикул, баркод, клиент и дополнительные характеристики, которому
            принадлежит этот товар.
          </p>
          <img
            src={images[1]}
            alt="Детали товара"
