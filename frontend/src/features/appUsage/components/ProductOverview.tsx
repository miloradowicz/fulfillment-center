    ...
    <Card className="rounded-2xl shadow-md">
      ...
      <CardContent className="space-y-6 text-sm leading-relaxed text-muted-foreground">
        ...
        <div>
          ...
          <ul className="list-disc pl-5">
            <li>Выбор клиента из списка</li>
            <li>Название товара</li>
            <li>Артикул</li>
            <li>Баркод</li>
            <li>Возможность добавления дополнительных характеристик</li>
          </ul>
          <p className="mt-2">
            ...
            <ol className="list-decimal pl-5 space-y-2">
              ...
              <li>
                ...
                <ul className="list-disc pl-5 mt-1">
                  <li><strong>Ключ</strong> — техническое название поля (латинскими строчными буквами, без пробелов).</li>
              ...
              <img
                ...
                className="mt-2 rounded-lg border shadow-sm w-5/6 mx-auto"
              />
              <li>После добавления появится новое поле, в которое нужно вписать <strong>значение</strong> параметра.</li>
              <img
                src={images[4]}
        ...
        <div>
          ...
          <p>
            ...
            перемещаются в архив и исключаются из основного списка. Стоит отметить, что товары, используемые
            в поставках или заказах, нельзя архивировать.
          </p>
        </div>
