      ...
      <CardContent className="space-y-6 text-sm leading-relaxed text-muted-foreground">
        ...
        <div>
          ...
          <div>
            ...
            <ul className="list-disc pl-5">
              <li><strong>«Подробнее»</strong> — открывает боковую панель с детальной информацией об услуге.</li>
          ...
          <div>
            ...
            <p>
              Если услуга больше не предоставляется, вы можете архивировать её. Такие услуги перемещаются в
        ...
        <div>
          ...
          <div>
            ...
            <ul className="list-disc pl-5">
              ...
              <li><strong>«Архивировать»</strong> — переместить счет в архив.</li>
            </ul>
            <img
              src={images[5]}
              alt="Список счетов"
          ...
          <div>
            ...
            <ul className="list-disc pl-5">
              ...
              <li><strong>Вкладки</strong> с детализацией по дополнительно оказанным услугам в заказах/поставках и
                истории изменений.
              </li>
            </ul>
            <img
          ...
          <div>
            ...
            <p className="mt-2">
              При редактировании счета отображается аналогичная форма.
            </p>
            <img
              src={images[7]}
              alt="Форма счетов"
          ...
          <div>
            ...
            <p>
              ...
              списка, но сохраняются в системе для истории и отчётности. Важно отметить что архивировать можно только
