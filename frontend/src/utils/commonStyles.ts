export const tabTriggerStyles =
  'data-[state=active]:bg-primary data-[state=active]:text-white hover:bg-primary/5 hover:text-primary px-3 py-1 my-1 text-sm sm:text-base rounded-3xl transition-all cursor-pointer'
